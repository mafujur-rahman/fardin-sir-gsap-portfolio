...
const Skills = () => {
    ...
    return (
        <section id="skills" className="bg-[#121212] text-white px-6 sm:px-8 md:px-12 xl:px-16 2xl:px-28 w-full min-h-screen flex items-center justify-center py-10 md:py-16  z-10">
